...
class EventsController extends BaseController
{
    ...
    public function __construct(Event $eventsDb) {
    ...
    public function getEventsWithWorkshops() {
        $eventListing = $this->eventsDb->findAllEvents(true);
        return response($eventListing);
    }
    ...
    public function getFutureEventsWithWorkshops() {
        $futureEvents = $this->eventsDb->getFutureEvents();
        return response($futureEvents);
    }
    
    public function getWarmUpEvents(){
        $eventLists = $this->eventsDb->findAllEvents();
        return response($eventLists);
    }
